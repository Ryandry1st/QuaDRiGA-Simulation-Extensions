...
if isfield(info.simulation, 'M')
    try
        tx_antenna_3gpp_3d.M = info.simulation.M;
        tx_antenna_3gpp_3d.N = info.simulation.N; 
        tx_antenna_3gpp_3d.pol = info.simulation.pol;
        tx_antenna_3gpp_3d.spacing = info.simulation.spacing;
    catch
        warning("Failed to set antenna parameters");
    end
end
...
if ~isOctave
    ...
    rand('state',seed); % TODO unsure if this is the same as MATLAB
end

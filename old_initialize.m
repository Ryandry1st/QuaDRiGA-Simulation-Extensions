...
DOWNTILT = 2;                            % Downtilt value, may not be manipulated in real system
N_SECTORS = 3;
% Rx_threshold_dBm = -200;

track_directory = ['D:\UT\Facebook\quadriga\tracks\DT',num2str(round(DOWNTILT)),'\',datestr(now,'mm-dd-HH-MM'),'\'];

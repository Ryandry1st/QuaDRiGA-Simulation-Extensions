...
if downtilt == -1
    for i=1:l.no_tx
        index = 3*(i-1)+1;
        l.tx_array(i) = qd_arrayant('3gpp-macro', AZI_BEAMWIDTH, ELE_BEAMWIDTH, -FB_RATIO_DB, orientations(index, 2));
        ...
        for j=1:N_SECTORS-1
            a = qd_arrayant('3gpp-macro', AZI_BEAMWIDTH, ELE_BEAMWIDTH, -FB_RATIO_DB, orientations(index+j, 2));
